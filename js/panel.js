/**
 * These include choice selector panel, algorithmic panel,play panel and instruction panel.
 */
var Panel = {
    init: function () {
    ...
    /**
     * Capturing the user chosen algorithm for finding the path.
     */
    getFinder: function () {
        ...
        switch (selected_header) {
            ...
            case 'astar_header':
                ...
                weight = weight >= 1 ? weight : 1; // Go for 1, if either negative or zero
